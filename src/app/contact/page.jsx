    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We're here to help bring your construction vision to life. Contact us through any of the following methods.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <p className="text-orange-600 font-medium">+233 XX XXX XXXX</p>
              <p className="text-orange-600 font-medium">+233 XX XXX XXXX</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <p className="text-orange-600 font-medium">info@prosperconstructionsgh.com</p>
              <p className="text-orange-600 font-medium">projects@prosperconstructionsgh.com</p>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h4 className="text-lg font-semibold mb-3 text-gray-900">How long does a typical construction project take?</h4>
              <p className="text-gray-600">
                Project timelines vary depending on size and complexity. Residential homes typically take 6-12 months, while commercial projects can take 12-24 months. We provide detailed timelines during the planning phase.
              </p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h4 className="text-lg font-semibold mb-3 text-gray-900">Do you provide free estimates?</h4>
              <p className="text-gray-600">
                Yes, we offer free initial consultations and estimates for all projects. Our team will visit your site, discuss your requirements, and provide a detailed quote within 5-7 business days.
              </p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h4 className="text-lg font-semibold mb-3 text-gray-900">Are you licensed and insured?</h4>
              <p className="text-gray-600">
                Absolutely. Prosper Constructions Limited is fully licensed by the Ghana Institution of Construction and holds comprehensive insurance coverage for all our projects and workers.
              </p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h4 className="text-lg font-semibold mb-3 text-gray-900">What areas do you serve?</h4>
              <p className="text-gray-600">
                We serve all regions of Ghana, with our main office in Accra. We have successfully completed projects in Greater Accra, Ashanti, Central, Western, and Northern regions.
              </p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h4 className="text-lg font-semibold mb-3 text-gray-900">Do you offer warranties on your work?</h4>
              <p className="text-gray-600">
      ...
      <section className="bg-orange-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h3 className="text-3xl font-bold mb-4">Ready to Build Your Dream Project?</h3>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Don't wait any longer. Contact us today and let's turn your construction vision into reality.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:+233XXXXXXXX" className="bg-white text-orange-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-block">
              Call Now
            </a>
            <a href="mailto:info@prosperconstructionsgh.com" className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-orange-600 transition-colors inline-block">
              Send Email
            </a>
          </div>
        </div>
